...
export default function FormPage() {
  ...
  return (
    <main className="min-h-screen bg-[#facd15] flex flex-col items-center p-4 md:p-8 font-poppins relative overflow-hidden">
      {/* Animated Background */}
      <AnimatedBackground />

      {/* Stepper Container */}
      <div className="w-full max-w-5xl bg-[#10375C]/90 backdrop-blur-md rounded-full p-4 md:px-12 md:py-6 mb-6 shadow-lg relative z-10 hidden md:block">
        <Stepper steps={steps} currentStep={currentStep} className="px-20 text-white" />
      </div>

      {/* Mobile Stepper (Simplified) */}
      <div className="w-full max-w-5xl bg-[#10375C] rounded-2xl p-4 mb-6 shadow-lg md:hidden flex justify-between items-center text-white relative z-10">
        <span className="text-yellow-400 font-bold">Step {currentStep}</span>
      ...
      <motion.div
        layout
        className="w-full max-w-5xl bg-[#10375C]/80 backdrop-blur-xl border border-white/20 rounded-[2.5rem] mb-30 p-6 md:p-12 shadow-2xl relative flex-1 text-white z-10"
      >
          ...
          {currentStep === 1 && (
            ...
            >
              ...
              <div className="flex justify-end">
                <Button onClick={handleNext} className="bg-white text-slate-900 hover:bg-yellow-400 hover:scale-105 transition-all rounded-full px-8 font-bold">
            ...
            >
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="nama" placeholder="Masukkan nama lengkap atau instansi" className="bg-white text-slate-900 border-none h-12 rounded-xl focus-visible:ring-yellow-400" value={formData.name} onChange={(e) => updateForm("name", e.target.value)} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="whatsapp" className="text-slate-300">
                    Nomor WhatsApp
                  </Label>
                  <Input id="whatsapp" placeholder="08xx xxxx xxxx" className="bg-white text-slate-900 border-none h-12 rounded-xl focus-visible:ring-yellow-400" value={formData.whatsapp} onChange={(e) => updateForm("whatsapp", formatPhoneNumber(e.target.value))} />
                </div>
                <div className="space-y-2">
                  <Label className="text-slate-300">Tertuju</Label>
                  <Select value={formData.to} onValueChange={(val) => updateForm("to", val)}>
                    <SelectTrigger className="bg-white text-slate-900 border-none h-12 rounded-xl focus:ring-yellow-400">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="keperluan" placeholder="Jelaskan keperluan Anda..." className="bg-white text-slate-900 border-none min-h-[80px] rounded-xl focus-visible:ring-yellow-400" value={formData.purpose} onChange={(e) => updateForm("purpose", e.target.value)} />
                </div>
              </div>
          ...
          {currentStep === 3 && (
            ...
            >
              ...
              <div className="flex justify-between mt-8">
                ...
                <Button onClick={handleSubmit} className="bg-white text-slate-900 hover:bg-yellow-400 hover:scale-105 transition-all rounded-full px-8 font-bold">
            ...
            >
              ...
              {qrCodeUrl && (
                <Button
                  ...
                  className="w-full max-w-sm bg-white text-slate-900 hover:bg-yellow-400 rounded-full h-12 font-bold text-lg shadow-lg">
